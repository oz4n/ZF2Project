...
class Post
{
     ...
     *
     * @ORM\ManyToMany(targetEntity="Album\Entity\TermTaxonomy", inversedBy="post")
     ...
     * Set parent
     *
     * @param \Album\Entity\Post $parent
     * @return Post
     */
    public function setParent(\Album\Entity\Post $parent = null)
    {
        $this->parent = $parent;
     ...
     * @return Post
     */
    public function addTermTaxonomy(\Album\Entity\TermTaxonomy $termTaxonomy)
    {
     ...
     * @param \Album\Entity\TermTaxonomy $termTaxonomy
     */
    public function removeTermTaxonomy(\Album\Entity\TermTaxonomy $termTaxonomy)
    {
