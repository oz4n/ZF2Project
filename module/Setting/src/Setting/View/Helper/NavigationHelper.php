...
class NavigationHelper extends AbstractHelper
{
    ...
    public function htmlify(AbstractPage $page, $escapeLabel = true, $addClassToListItem = false)
    {
        ...
        if ($page->isDropdown) {
            ...
            $extended = '<b class="arrow icon-angle-down"></b>';
        }
        if (count($class) > 0) {
        ...
        if ($escapeLabel === true) {
            ...
            $html .= '<i class="' . $page->getId() . '"></i> <span class="mm-text">' . $escaper($label) . '</span>';
        } else {
            $html .= '<i class="' . $page->getId() . '"></i> ' . $label;
        }
