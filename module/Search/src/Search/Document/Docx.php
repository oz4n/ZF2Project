...
class Docx extends OpenXml
{
    ...
    private function __construct($fileName, $storeContent)
    {
        if (!class_exists('ZipArchive', false)) {
            throw new Exception('MS Office documents processing functionality requires Zip extension to be loaded');
        }
        ...
        if ($relationsXml === false) {
            ...
            throw new Exception('Invalid archive or corrupted .docx file.');
        }
