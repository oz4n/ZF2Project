...
class Html extends Document
{
        ...
        foreach ($matchedTokens as $token) {
            ...
            $success = @$highlightedWordNodeSetDomDocument->
                            loadHTML('<html><head><meta http-equiv="Content-type" content="text/html; charset=UTF-8"/></head><body>'
                                    ...
                                    . '</body></html>');
            if (!$success) {
                throw new Exception("Error occured while loading highlighted text fragment: '$highlightedWordNodeSetHtml'.");
            }
    ...
    public function highlightExtended($words, $callback, $params = array())
    {
        ...
        if (!is_callable($callback)) {
            throw new Exception('$viewHelper parameter must be a View Helper name, View Helper object or callback.');
        }
