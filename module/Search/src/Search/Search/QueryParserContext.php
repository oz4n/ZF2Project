...
use Search\Search\BooleanExpressionRecognizer;
...
class QueryParserContext
{
    ...
    public function setNextEntrySign($sign)
    {
        if ($this->_mode === self::GM_BOOLEAN) {
            ...
            throw new Exception('It\'s not allowed to mix boolean and signs styles in the same subquery.');
        }
        ...
        if ($sign == QueryToken::TT_REQUIRED) {
            ...
            throw new Exception('Unrecognized sign type.');
        }
    }
    ...
    public function processFuzzyProximityModifier($parameter = null)
    {
        ...
        if ($this->_nextEntryField !== null || $this->_nextEntrySign !== null) {
            ...
            throw new Exception('\'~\' modifier must follow word or phrase.');
        }
    ...
    public function boost($boostFactor)
    {
        ...
        if ($this->_nextEntryField !== null || $this->_nextEntrySign !== null) {
            ...
            throw new Exception('\'^\' modifier must follow word, phrase or subquery.');
        }
    ...
    private function _booleanExpressionQuery()
    {
        ...
        try {
            foreach ($this->_entries as $entry) {
                if ($entry instanceof QueryEntry) {
                    ...
                    switch ($entry) {
                        ...
                        default:
                            throw new Exception('Boolean expression error. Unknown operator type.');
                    }
                }
            }
            ...
            // throw new Exception('Boolean expression error. Error message: \'' .
            //                                                          $e->getMessage() . '\'.' );
            // It's query syntax error message and it should be user friendly. So FSM message is omitted

            throw new Exception('Boolean expression error.', 0, $e);
        }
