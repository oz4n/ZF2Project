...
class DictionaryLoader
{
    ...
    public static function load($data)
    {
        ...
        if ($tiVersion != (int) 0xFFFFFFFE /* pre-2.1 format */ &&
            ...
            throw new Exception('Wrong TermInfoIndexFile file format');
        }
        ...
        if (PHP_INT_SIZE > 4) {
            ...
            if ((ord($data[$pos]) != 0) ||
                ...
                throw new Exception('Largest supported segment size (for 32-bit mode) is 2Gb');
            }
        ...
        $pos += 4;
        if ($indexTermCount < 1) {
            throw new Exception('Wrong number of terms in a term dictionary index');
        }
