...
use Search\Index\SegmentWriter;
...
class DocumentWriter extends SegmentWriter
{
    ...
    public function addDocument(Document $document)
    {
        ...
        foreach ($document->getFieldNames() as $fieldName) {
            ...
            if ($field->storeTermVector) {
                 ...
                 */
                throw new Exception('Store term vector functionality is not supported yet.');
            }
            ...
            if ($field->isIndexed) {
                if ($field->isTokenized) {
                    ...
                    $term = new Term($fieldUtf8Value, $field->name);
                    $termKey = $term->key();
    ...
    public function close()
    {
        ...
        return new SegmentInfo($this->_directory, $this->_name, $this->_docCount, -1, null, true, true);
    }
