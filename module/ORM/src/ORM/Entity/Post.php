...
class Post {
	...
	/**
	 *
	 * @var string @ORM\Column(name="slug", type="text", nullable=false)
	 */
	private $slug;
	
	/**
	 *
	 * @var string @ORM\Column(name="tags", type="text", nullable=true)
	 */
	private $tags;
	...
	/**
	 *
	 * @var \DateTime @ORM\Column(name="create_time", type="datetime", nullable=false)
	 */
	private $createTime;
	
	/**
	 *
	 * @var \DateTime @ORM\Column(name="update_time", type="datetime", nullable=false)
	 */
	private $updateTime;
	
	/**
	 *
	 * @var string @ORM\Column(name="comment_status", type="string", length=5, nullable=true)
	 */
	private $commentStatus = 'E';
	
	/**
	 *
	 * @var string @ORM\Column(name="post_status", type="string", length=25, nullable=true)
	 */
	private $postStatus;
	...
	/**
	 *
	 * @var \Doctrine\Common\Collections\Collection @ORM\ManyToMany(targetEntity="ORM\Entity\TermTaxonomy", inversedBy="post")
