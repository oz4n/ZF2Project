...
class TermTaxonomy {
	...
	/**
	 *
	 * @var string @ORM\Column(name="count", type="string", length=45, nullable=false)
	 */
	private $count = '0';
	
	/**
	 *
	 * @var string @ORM\Column(name="status", type="string", length=45, nullable=false)
	 */
	private $status = 'D';
	...
	/**
	 *
	 * @var \ORM\Entity\Terminologi @ORM\ManyToOne(targetEntity="ORM\Entity\Terminologi")
	 *      @ORM\JoinColumns({
	...
	/**
	 *
	 * @var \ORM\Entity\TermTaxonomy @ORM\ManyToOne(targetEntity="ORM\Entity\TermTaxonomy")
	 *      @ORM\JoinColumns({
	...
	/**
	 *
	 * @var \Doctrine\Common\Collections\Collection @ORM\ManyToMany(targetEntity="ORM\Entity\Post", mappedBy="termTaxonomy")
	 */
	private $post;
