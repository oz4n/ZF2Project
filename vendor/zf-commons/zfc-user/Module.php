        ...
        return array(
            ...
            'factories' => array(
                ...
                'zfcuser_register_form' => function ($sm)
                {
                    ...
                    $form->setInputFilter(new Form\RegisterFilter(new Validator\NoRecordExists(array(
                ...
                'zfcuser_change_email_form' => function ($sm)
                {
                    ...
                    $form->setInputFilter(new Form\ChangeEmailFilter($options, new Validator\NoRecordExists(array(
                        'mapper' => $sm->get('zfcuser_user_mapper'),
                        'key' => 'email'
                    ))));
                    return $form;
