...
//
    ...
    var demo_themes = [
        {name: 'default', title: 'Default', img: getBaseURL() + 'assets/PixelAdmin/img/themes/default.png'},
        {name: 'asphalt', title: 'Asphalt', img: getBaseURL() +  'assets/PixelAdmin/img/themes/asphalt.png'},
        {name: 'purple-hills', title: 'Purple Hills', img: getBaseURL() + 'assets/PixelAdmin/img/themes/purple-hills.png'},
        {name: 'adminflare', title: 'Adminflare', img: getBaseURL() + 'assets/PixelAdmin/img/themes/adminflare.png'},
        {name: 'dust', title: 'Dust', img: getBaseURL() + 'assets/PixelAdmin/img/themes/dust.png'},
        {name: 'frost', title: 'Frost', img: getBaseURL() + 'assets/PixelAdmin/img/themes/frost.png'},
        {name: 'fresh', title: 'Fresh', img: getBaseURL() + 'assets/PixelAdmin/img/themes/fresh.png'},
        {name: 'silver', title: 'Silver', img: getBaseURL() + 'assets/PixelAdmin/img/themes/silver.png'},
        {name: 'clean', title: 'Clean', img: getBaseURL() + 'assets/PixelAdmin/img/themes/clean.png'},
        {name: 'white', title: 'White', img: getBaseURL() + 'assets/PixelAdmin/img/themes/white.png'}
    ];
